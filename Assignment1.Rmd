...
hist(dat$Distance, breaks = seq(0, 700, 10), col="red") # Pre-outlier analysis
hist(distDat$Distance, breaks = seq(0, 250, 10), col="red") # Post-outlier analysis
...
ggplot(data=distPlotDat1, aes(x=Position, y=Distance, fill=Sex))+
        ...
        scale_y_continuous(breaks=seq(0, 80, 10), limits=c(0, 80), 
                           expand=c(0,0))+
        ylab("Distance from Partner (cm)")+
        theme_bw()+ # Update to theme_base later
